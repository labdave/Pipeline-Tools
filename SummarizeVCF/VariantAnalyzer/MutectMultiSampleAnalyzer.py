...
class MutectMultiSampleAnalyzer(object):
    ...
    def declare_required_count_fields(self):
        ...
        required_fields = ["Missing GT", "Called GT", "Passed Filter", "Variant GT", "Heterozygous", "Homozygous-Alt", "Deletions", "Insertions",
    ...
    def analyze(self, record, vcf_summary):
        ...
        passed_filter   = len(record.FILTER) == 0
        ...
        for sample in record.samples:
            ...
            if not passed_filter:
                # Skip variants that didn't pass the filter
                continue
